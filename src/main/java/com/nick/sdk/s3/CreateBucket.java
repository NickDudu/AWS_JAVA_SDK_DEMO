...
public class CreateBucket {
    public static void main(String[] args) {
        ...
        GetObjectRequest.Builder test1 = GetObjectRequest.builder().bucket("testnickhu").key("test.txt").ifModifiedSince(Instant.now());
        ...
        Instant type = objectHead.lastModified();
